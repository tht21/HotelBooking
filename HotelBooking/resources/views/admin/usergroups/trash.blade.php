                     ...
                     <tr>
                        ...
                        <td>
                           <div class="form-button-action">
                              <a href="{{route('usergroups.restore',$item->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Khôi Phục Nhóm Nhân Viên">
                                 <i class="fas fa-trash-restore"></i>
                              </a>
                           
                              <form action="{{ route('usergroups.force_destroy',$item->id)}}" style="display:inline" method="post">
                                 <button onclick="return confirm('Xóa {{$item->name}} ?')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Xóa Vĩnh Viễn" ><i class="far fa-trash-alt"></i></button>
                                 @csrf
                                 @method('delete')
                             </form>
                           </div>
