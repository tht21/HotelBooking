                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="tf1">Tên nhóm</label> <input name="name" value="{{$item->name }}"
                                                                             type="text"
                                                                             class="form-control" id=""
                                                                             placeholder="Nhập tên nhóm"> <small id=""
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-check form-switch ">{{__('CheckAll')}}
                                        <input style="margin-left: 0.5em;" type="checkbox" id="checkAll"
                                ...
                                <div class="form-actions">
                                    <a class="btn btn-secondary float-right "
                                       href="{{route('usergroups.index')}}">Hủy</a>
