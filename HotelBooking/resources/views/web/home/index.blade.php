                    ...
                    <article class="room">
                        <figure>
                            ...
                            <a class="hover_effect h_blue h_link" href="room.html">
                                <img src="{{asset('web/images/rooms/single-room.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="room">
                        <figure>
                            ...
                            <a class="hover_effect h_blue h_link" href="room.html">
                                <img src="{{asset('web/images/rooms/double-room.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="room">
                        <figure>
                            ...
                            <a class="hover_effect h_blue h_link" href="room.html">
                                <img src="{{asset('web/images/rooms/deluxe-room.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                            <figcaption>
                ...
                <div class="image-gallery">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery1.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery1.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery2.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery2.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery3.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery3.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery4.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery4.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery5.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery5.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery6.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery6.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery7.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery7.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery8.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery8.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery9.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery9.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery10.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery10.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery11.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery11.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <figure class="gs2_item">
                            <a href="{{asset('web/images/gallery/gallery12.jpg')}}"
                               class="hover_effect h_lightbox h_blue">
                                <img src="{{asset('web/images/gallery/gallery12.jpg')}}" class="img-responsive"
                                     alt="Image">
                            </a>
                        </figure>
                    </div>
