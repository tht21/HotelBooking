                            ...
                            @foreach ($rooms as $key => $room)
                                @if ($room->status == 'còn phòng')
                                    <div class="col-md-4">
                                        <article>
                                            <figure>
                                                <a href="#" class="hover_effect h_blue h_link"><img
                                                        src="{{$room->image_path}}" alt="Image"
                                                        class="img-responsive"></a>
                                                <div class="price">{{number_format($room->price)}} VNĐ<span> Đêm</span>
                                                </div>
                                                <figcaption>
                                                    <h4>
                                                        <a href="">{{$room->room_type ? $room->room_type->name : ''}}</a>
                                                    </h4>
                            ...
                            <div class="vbf">
                                ...
                                <form id="booking-form" class="inner">
                                    <div class="form-group">
                                        <input class="form-control" name="booking-name" placeholder="Nhập tên"
                                               type="text">
                                    </div>
                                    <div class="form-group">
